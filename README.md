...
├── mainWizard.js          # Hlavný shell - inicializácia, routing, Firebase
├── emp_module.js          # Modul správy zamestnancov
├── edit_module.js         # Modul editovania zamestnancov
├── schd_module.js         # Modul rozpisov pohotovostí
├── cp_module.js           # Modul cestovných príkazov
├── ua_module.js           # Modul príspevkov úrazového poistenia
├── styles.css             # Globálne štýly a dizajn systém
├── data/
│   ├── cp.docx           # Šablóna cestovného príkazu
│   └── vykaz_pohotovosti.docx  # Šablóna výkazu pohotovosti
└── fonts/
    └── DejaVuSans.ttf    # Font pre PDF s diakritkou
```
