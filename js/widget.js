...
export async function updateWelcomeWidget(user) {
    ...
    const meninyEl = document.getElementById('welcome-meniny');
    const sviatokEl = document.getElementById('welcome-sviatok');
    const iconEl = document.getElementById('welcome-icon');
    const tempEl = document.getElementById('welcome-temp');
