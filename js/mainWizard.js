...
/**
 * Inicializuje logiku pre mobilné "hamburger" menu.
 */
function initializeMobileMenu() {
    ...
    if (!leftToggle || !rightToggle || !leftSidebar || !rightSidebar) {
        console.warn("Mobilné menu sa nepodarilo inicializovať. Chýbajú tlačidlá alebo sidebary.");
        return;
    }
...
async function loadDashboardDutyToday(db) {
    ...
    // Obmedzenie: Iba vedúci odboru a oddelenia majú vidieť pohotovosť (podľa Permissions)
    //if (!Permissions.canViewModule(activeUser, 'pohotovost-module')) {
       // listElement.innerHTML = '<li>Nemáte oprávnenie vidieť rozpis pohotovosti.</li>';
       // return;
   // }
